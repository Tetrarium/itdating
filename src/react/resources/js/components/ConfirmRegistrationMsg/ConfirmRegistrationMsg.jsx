...
import './ConfirmRegistrationMsg.scss';
...
function ConfirmRegistrationMsg({ mail = 'test@test.com', onBackClick = stubHandler }) {
    ...
    return (
        <div className="confirm-reg">
            <div className="confirm-reg__description">
                <p className="confirm-reg__text">Для подтверждения регистрации мы отправили вам письмо по адресу <span
                    className="confirm-reg__mail">{mail}</span>.</p>
                <p className="confirm-reg__text">Проверьте указанный адрес электронной почты для подтверждения данных
                    аккаунта</p>
            </div>
...
export default ConfirmRegistrationMsg;
